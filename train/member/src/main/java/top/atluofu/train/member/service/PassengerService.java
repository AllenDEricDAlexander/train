...
import top.atluofu.train.member.domain.Passenger;
import top.atluofu.train.member.domain.PassengerExample;
import top.atluofu.train.member.enums.PassengerTypeEnum;
import top.atluofu.train.member.mapper.MemberMapper;
import top.atluofu.train.member.mapper.PassengerMapper;

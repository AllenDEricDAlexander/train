package top.atluofu.train.${module}.service;
...
import top.atluofu.train.${module}.domain.${Domain};
import top.atluofu.train.${module}.domain.${Domain}Example;
import top.atluofu.train.${module}.mapper.${Domain}Mapper;

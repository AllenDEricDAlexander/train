<template>
  ...
  <div style="border: 4px solid orange;
    ...
    <h3>
      <b>本项目的配套视频课程：
        <a href="https://allendericdalexander.github.io/2024/01/13/data_sharing1/"
           target="_blank">
    ...
    <div>
      一套市面稀缺的，手把手教你完整落地“高并发，高可用，高性能” 整体解决方案实战课。课程以12306售票系统驱动教学，融合老师多年大厂超大型项目架构设计与实战经验，带你从架构设计到具体场景方案落地，真正驾驭超高并发场景下的各种疑难问题，成为高薪抢手人才。
    </div>
  </div>
  <a-divider style="border-color: #7cb305"
             dashed />
